...
-- 데이터베이스: `hahaha`
--
CREATE DATABASE IF NOT EXISTS `hahaha` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hahaha`;
...
INSERT INTO `friday` (`event`, `title`, `date`) VALUES
('오늘놀아', '10월정규이벤트', '2022-10-28');
...
-- 데이터베이스: `lshdb`
--
CREATE DATABASE IF NOT EXISTS `lshdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `lshdb`;
...
CREATE TABLE `friends` (
  ...
  `ftel` char(11) DEFAULT NULL,
  `faddr` varchar(200) DEFAULT NULL,
  `fmsg` text DEFAULT NULL,
...
(1, '타인은 지옥이다', '임시완,이동욱', 'OCN', '토,일', '10:30', '10부작', '2022-11-22 05:11:05'),
(2, '열여덟의 순간', '옹성우,김향기', 'JTBC', '월,화', '09:30', '16부작', '2022-11-11 06:51:50'),
(3, '펜트하우스2', '유진,김소연', 'SBS', '금,토', '10:00', '20부작', '2022-11-11 06:51:50'),
(4, '선배, 그 립스틱 바르지 마요', '로운,원진아', 'JTBC', '월,화', '09:00', '16부작', '2022-11-11 06:51:50'),
(5, '시지프스 : the myth', '조승우,박신혜', 'JTBC', '수,목', '09:00', '20부작', '2022-11-11 06:51:50');
...
--
ALTER TABLE `drama_info`
  MODIFY `idx` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- 데이터베이스: `northwind`
--
...
--
-- 테이블의 덤프 데이터 `employee_privileges`
--
...
--
-- 테이블의 덤프 데이터 `inventory_transactions`
--
...
--
-- 테이블 구조 `inventory_transaction_types`
--
...
--
-- 테이블의 덤프 데이터 `inventory_transaction_types`
--
...
--
-- 테이블의 덤프 데이터 `order_details_status`
--
...
--
-- 테이블의 덤프 데이터 `purchase_order_details`
--
...
--
-- 테이블의 덤프 데이터 `purchase_order_status`
--
...
--
-- 테이블의 인덱스 `inventory_transactions`
--
...
--
-- 테이블의 인덱스 `inventory_transaction_types`
--
...
--
-- 테이블의 인덱스 `orders_status`
--
ALTER TABLE `orders_status`
  ADD PRIMARY KEY (`id`);

--
-- 테이블의 인덱스 `orders_tax_status`
--
...
--
-- 테이블의 인덱스 `purchase_order_details`
--
...
--
-- 테이블의 인덱스 `purchase_order_status`
--
ALTER TABLE `purchase_order_status`
  ADD PRIMARY KEY (`id`);

--
-- 테이블의 인덱스 `sales_reports`
--
...
--
-- 테이블의 AUTO_INCREMENT `inventory_transactions`
--
ALTER TABLE `inventory_transactions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- 테이블의 AUTO_INCREMENT `invoices`
--
ALTER TABLE `invoices`
...
--
-- 테이블의 AUTO_INCREMENT `privileges`
--
ALTER TABLE `privileges`
...
--
-- 테이블의 AUTO_INCREMENT `purchase_order_details`
--
ALTER TABLE `purchase_order_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=296;

--
-- 테이블의 AUTO_INCREMENT `shippers`
--
ALTER TABLE `shippers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 테이블의 AUTO_INCREMENT `strings`
--
ALTER TABLE `strings`
...
--
-- 테이블의 제약사항 `inventory_transactions`
--
ALTER TABLE `inventory_transactions`
...
--
-- 테이블의 제약사항 `purchase_order_details`
--
ALTER TABLE `purchase_order_details`
...
-- 데이터베이스: `nwdb`
--
CREATE DATABASE IF NOT EXISTS `nwdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `nwdb`;
--
-- 데이터베이스: `phpmyadmin`
--
...
('root', '[{\"db\":\"mydb\",\"table\":\"drama_info\"},{\"db\":\"northwind\",\"table\":\"orders\"},{\"db\":\"northwind\",\"table\":\"customers\"},{\"db\":\"northwind\",\"table\":\"inventory_transactions\"},{\"db\":\"today1103\",\"table\":\"todolist\"},{\"db\":\"today1103\",\"table\":\"todolist2\"},{\"db\":\"today1101\",\"table\":\"todolist\"},{\"db\":\"hahaha\",\"table\":\"friday\"},{\"db\":\"hahaha\",\"table\":\"mytable\"},{\"db\":\"lshdb\",\"table\":\"savemoney\"}]');
...
('root', '2022-11-25 03:11:20', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ko\"}');
...
-- 데이터베이스: `today1101`
--
CREATE DATABASE IF NOT EXISTS `today1101` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `today1101`;
...
INSERT INTO `todolist` (`idx`, `title`, `cont`, `sysdate`, `auth`) VALUES
(1, 'SQL 데이터 넣기', 'insert int로 데이터를 넣어보자', '2022-11-01 07:15:28', 'U'),
(2, 'SQL 데이터 빼기', 'select로 데이터를 빼보자', '2022-11-01 07:18:52', 'A'),
(4, 'SQL 데이터 빼기', 'select로 데이터를 빼보자', '2022-11-01 07:20:55', 'A');
...
-- 데이터베이스: `today1103`
--
CREATE DATABASE IF NOT EXISTS `today1103` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `today1103`;
...
INSERT INTO `todolist` (`idx`, `title`, `cont`, `sysdate`, `auth`, `mynum`) VALUES
(1, 'SQL 데이터넣기', 'insert int로 데이터를 넣어보자!', '2022-11-04 00:42:34', 'U', NULL),
(2, 'SQL 데이터빼기', 'select로 데이터를 빼보자!', '2022-11-04 00:42:48', 'A', NULL),
(3, '333', 'select로 데이터를 빼보자!', '2022-11-04 00:43:07', 'A', NULL),
(4, 'SQL 데이터빼기', 'select로 데이터를 빼보자!', '2022-11-04 00:43:16', 'A', NULL),
(5, '금요일준비일정', '금요일엔 불금,놀자!!!', '2022-11-04 00:43:35', 'U', 10),
(6, '목요일준비일정', '목요일엔 불목,놀자!!!', '2022-11-04 00:43:42', 'U', 0);
